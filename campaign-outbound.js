      ...
      const setupElevenLabs = async () => {
        try {
          ...
          elevenLabsWs.on("open", () => {
            ...
            // Extract metadata from customParameters for webhook identification
            ...
            const callSidParam = callSid || customParameters?.call_sid || null;
            ...
            // Also add metadata to conversation_initiation_client_data
            ...
            console.log(
              "[ElevenLabs] Sending initial config with metadata:",
              "call_sid:", callSidParam,
              "contact_id:", contactId,
              "campaign_id:", campaignId
            );
...
fastify.listen({ port: PORT, host: "0.0.0.0" }, (err) => {
  ...
  console.log(
    `[Server] Ready to handle ElevenLabs calls`
  );
});
